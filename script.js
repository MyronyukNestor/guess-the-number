...
document.querySelector(".check").addEventListener("click", function () {
  ...
  if (!guessingNumber) {
    ...
    if (score > 1) {
      ...
      displayGuessMessage("Гра закінчена!");
      document.querySelector(".question").textContent = secretNumber;
  ...
  //  else if (guessingNumber > secretNumber) {
  //   if (score > 1) {
  //     document.querySelector('.guess-message').textContent = 'Забагато!';
  //     score--;
  //     document.querySelector('.score').textContent = score;
  //   } else {
  ...
  // } else if (guessingNumber < secretNumber) {
  //   if (score > 1) {
  //     document.querySelector('.guess-message').textContent = 'Замало!';
  //     score--;
  //     document.querySelector('.score').textContent = score;
  //   } else {
  //     document.querySelector(".guess-message").textContent = 'Гра закінчена!';
...
document.querySelector(".again").addEventListener("click", function () {
  ...
  displayGuessMessage("Почніть угадувати!");
